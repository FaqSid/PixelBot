...
// @downloadURL  https://raw.githubusercontent.com/FaqSid/PixelBot/master/PixelDefender.js
// @updateURL    https://raw.githubusercontent.com/FaqSid/PixelBot/master/PixelDefender.js
// @grant        none
// ==/UserScript==

function MyAwesomePixelBot() {
    var slvimg = {"currentTarget": "https://i.imgur.com/jLCWXKT.png"};
    window.MyAwesomePixelBot = MyAwesomePixelBot;
    MyAwesomePixelBot.url = {
        script: 'https://raw.githubusercontent.com/FaqSid/PixelBot/master/PixelDefender.js'
    };
    ...
    MyAwesomePixelBot.urlGen = {
        ...
        image: function() {
            return new Promise(function(resolve, reject) {
                fetch('https://raw.githubusercontent.com/FaqSid/PixelBot/master/defence.json').then(function(data) {
    ...
    MyAwesomePixelBot.setState = function(s) {
        MyAwesomePixelBot.state.innerHTML = "БРАТИШКИН ПИДОР 2.0 " + s;
    ...
    MyAwesomePixelBot.canvasClick = function(x, y, color) {
        ...
        var colors ={'rgb(250, 251, 252)' : 'color--1',
					'rgb(197, 210, 224)' : 'color--2',
                    'rgb(153, 153, 153)' : 'color--3',
                    'rgb(34, 34, 34)' : 'color--5',
                    'rgb(148, 224, 68)' : 'color--6',
                    'rgb(253, 203, 93)' : 'color--9'};

        var ColElem = colors[color];
        var colorEl = document.getElementsByClassName(ColElem)[0];
